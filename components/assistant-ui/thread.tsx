...
const TypingIndicator: FC = () => {
  ...
  return (
    <div className="aui-assistant-message-root relative mx-auto w-full max-w-(--thread-max-width) animate-in py-4 duration-150 ease-out fade-in slide-in-from-bottom-1">
      <div className="aui-assistant-message-content mx-2 flex items-center gap-1">
